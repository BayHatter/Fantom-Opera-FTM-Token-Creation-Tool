# Fantom Token Creation Tool

A simple frontend tool to create tokens on the Fantom (FTM) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Fantom-Opera-FTM-Token-Creation-Tool.git
- And press deploy
- Congrats your Fantom Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Fantom-Opera-FTM-Token-Creation-Tool
- Upload into your Github repo.
- Edit the file public/config.json and insert your Fantom wallet address for receiving fees. Also set fee in FTM that you want to charge
